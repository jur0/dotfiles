...
###############################################################################
# Apple Game center (gamed process)                                           #
###############################################################################
# Howto switch it off:
# https://discussions.apple.com/thread/7941428?start=15&tstart=0
...
defaults write .GlobalPreferences com.apple.trackpad.scaling -float 2.5
